...
|
*/
$config['base_url'] = 'http://localhost/TESI/';
$config['risorse'] = array(
    'css' => $config['base_url'].'risorse/css',
    'img' => $config['base_url'].'risorse/img',
    'js' => $config['base_url'].'risorse/js',
    'py' => $config['base_url'].'risorse/py',
    'vendor' => $config['base_url'].'risorse/vendor',
    'database_sites' => $config['base_url'].'risorse/database_sites',
);
